...
// output Monday
// change value to 'Friday'
dayOfWeek = 'Friday';
// print 'I can't wait for Friday!' to console
console.log("I can't wait for " + dayOfWeek + "!");
// expected output is I can't wait for Friday!
...
//// create variable called animalInput
//animalInput = prompt('What is your favorite animal? ')
//colorInput = prompt('What is your favorite color? ')
//// combine these two into one string
//console.log("I've never seen a " + colorInput + animalInput + "!");
// exected output is "I've never seen a blackWolf !"
//
...
chosenMeal = 'Eggs' || 'Turkey sandwich' || '12oz fillet';
...
//  variable for timeOfDay = = = elevenHundredHours
